...
struct SimpleTournamentConfig : public core::PropertySet {
...
//!
class SimpleTournament : public Tournament {
 public:
  explicit SimpleTournament(const core::PropertySet& config);

  void evaluatePopulation(darwin::Population* population, GameRules* game_rules) override;

 private:
  SimpleTournamentConfig config_;
};
