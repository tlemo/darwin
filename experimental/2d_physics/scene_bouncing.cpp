...
Scene::Scene() : physics::Scene(b2Vec2(0, -9.8f), physics::Rect(-100, -100, 200, 200)) {
  ...
  physics::addBall(-80, 90, 1, &world_);
  physics::addBall(-70, 80, 2, &world_);
  physics::addBall(-60, 70, 3, &world_);

  auto ball4 = physics::addBall(-50, 60, 5, &world_);
  ball4->ApplyAngularImpulse(500.0f, true);

  physics::addBox(0, 50.0f, 1, 1, &world_);
  physics::addBox(10, 50.0f, 1, 5, &world_);

  auto box3 = physics::addBox(20, 50.0f, 5, 1, &world_);
